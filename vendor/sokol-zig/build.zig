...
pub const SokolBuildOpts = extern struct {
...
pub fn buildSokol(
    ...
    const lib = b.addStaticLibrary(.{
        .name = "sokol",
        .root_source_file = .{ .path = prefix_path ++ "src/sokol_zig_hooks.zig" },
        .target = target,
        .optimize = mode,
    });
...
fn buildExample(b: *Build, target: CrossTarget, mode: Mode, sokol: *LibExeObjStep, comptime name: []const u8) void {
